      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <h1 className="text-2xl font-extrabold" style={{ color: "var(--color-text-heading)" }}>🏆 チーム学習状況</h1>
          </div>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ backgroundColor: "var(--color-page)" }}>
                ...
                <th className="text-left font-bold px-6 py-4" style={{ color: "var(--color-text-muted)" }}>メール</th>
              ...
              {leaderboard.length === 0 ? (
                ...
                leaderboard.map((entry, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-bold" style={{ color: "var(--color-text-heading)" }}>{entry.name}</td>
                    ...
                    <td className="px-6 py-4 text-right font-extrabold" style={{ color: "var(--color-yellow)" }}>
                      {entry.xp.toLocaleString()}
                    </td>
                    <td className="px-6 py-4 text-right font-bold" style={{ color: "var(--color-green)" }}>
                      Lv.{entry.level}
                    </td>
